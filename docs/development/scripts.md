...
Headless Filesystem Browser state test for filtering, multi-selection restoration, scaled chrome bands, status-bar hit testing, scroll clamping, delete confirmation, and partial cut/paste:
