...
Headless Filesystem Browser state test for filtering, multi-selection restoration, scaled chrome bands, status-bar hit testing, tiny-client row bounds, scroll clamping, delete confirmation, and partial cut/paste:
