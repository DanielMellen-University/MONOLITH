...
Headless Drawing state test for clean loads, resize dirty tracking, history reset, font-scaled chrome, scaled canvas pointer mapping, and duplicate file singleton rejection:
