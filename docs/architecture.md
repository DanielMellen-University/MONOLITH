...
- Focus callbacks reflect actual client activity: host-unfocused and Start-menu transitions suppress nested handoff callbacks, and closing the menu resumes the window that owns logical focus after any callback-triggered changes.
