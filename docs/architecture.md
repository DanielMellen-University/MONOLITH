...
- Static shell labels, including the taskbar Start button, Start-menu header, category labels, and normal or hovered rows, are keyed by text and color and cached between frames; the cache is rebuilt only after the shared font changes.
