...
- Captured app gestures own the pointer until release: Drawing clamps captured strokes to the canvas edge, and Text Editor clamps captured selection motion to the nearest visible document edge when the pointer leaves its text viewport.
