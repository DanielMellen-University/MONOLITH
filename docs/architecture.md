...
- The static Start-menu "Monolith" header is cached between frames and rebuilt only after the shared font changes, avoiding repeated SDL_ttf surface and texture creation while the menu is open.
